...
export const createProjectConfiguration = (
  ...
  return {
    ...
    targets: {
      ...
      invoke: {
        executor: 'serverless-cdk:invoke',
        options: {
          terraformDirectory: terraformDirectoryPath,
          samConfiguration: samConfigurationPath,
        },
    ...
    tags: [`app:${options.serviceName}`, 'serverless-cdk:service'],
  };
};
