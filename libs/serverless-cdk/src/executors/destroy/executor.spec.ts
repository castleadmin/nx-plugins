...
describe('Destroy Executor', () => {
  ...
  describe('Unix', () => {
    let options: DestroyExecutorSchema;
    ...
    describe('workspace', () => {
      it('Should select the workspace.', async () => {
        ...
        expect(executeCommand).toHaveBeenCalledWith(
          'terraform workspace select app_test && terraform destroy -input=false',
          {
    ...
    describe('interactive', () => {
      it('Should execute command interactively.', async () => {
        ...
        expect(executeCommand).toHaveBeenCalledTimes(1);
        expect(executeCommand).toHaveBeenCalledWith(
          'terraform workspace select app_test && terraform destroy -input=true',
          {
            cwd: '/home/castleadmin/projects/awesome/apps/test/terraform',
            shell: undefined,
          }
    ...
    describe('args', () => {
      it('Should execute command with custom arguments.', async () => {
        ...
        expect(executeCommand).toHaveBeenCalledTimes(1);
        expect(executeCommand).toHaveBeenCalledWith(
          'terraform workspace select app_test && terraform destroy -input=false -no-color -parallelism=8',
          {
            cwd: '/home/castleadmin/projects/awesome/apps/test/terraform',
            shell: undefined,
          }
